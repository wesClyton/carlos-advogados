        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <div class="logo-footer"><img src="<?php echo get_template_directory_uri(); ?>/img/logo-footer.png" alt=""></div>
                    ...
                    <div class="copyright">
                        ©<?php echo date('Y') ?> - Todos os direitos reservados à Carlos Alberto dos Santos & Advogados Associados
                    </div>
                </div>
            </div>
        </div>
